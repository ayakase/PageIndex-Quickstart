...
def print_and_track_usage(response):
    """Prints and tracks token usage from the OpenAI response."""
...
def print_total_usage():
    """Prints the cumulative total token usage for the session."""
    print("\n" + "="*30)
...
def ChatGPT_API_with_finish_reason(model, prompt, api_key=CHATGPT_API_KEY, chat_history=None):
    ...
    for i in range(max_retries):
        try:
            ...
            print_and_track_usage(response)
